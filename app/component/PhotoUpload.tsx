    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                ...
                <TouchableOpacity onPress={this._pickImage} style={styles.CamberaStyle} activeOpacity={0.5}>
                    <Entypo className={styles.IconsStyle} name="folder-images" size={65} color="black" />
                </TouchableOpacity>
        ...
        try {
            ...
            if (!pickerResult.cancelled) {
                try {
                    ...
                    await Utils.addUserImage(`${uploadResult.filename}`)
